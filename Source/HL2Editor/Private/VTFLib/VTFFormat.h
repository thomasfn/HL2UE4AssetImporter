...
#define MAKE_VTF_RSRC_ID(a, b, c) ((unsigned int)(((unsigned char)a) | ((unsigned char)b << 8) | ((unsigned char)c << 16)))
#define MAKE_VTF_RSRC_IDF(a, b, c, d) ((unsigned int)(((unsigned char)a) | ((unsigned char)b << 8) | ((unsigned char)c << 16) | ((unsigned char)d << 24)))
